...
This document describes how @sebastienrousseau/shell-config is run: who decides what, how
...
@sebastienrousseau/shell-config is **maintainer-led**. As of the current release line it has a single
